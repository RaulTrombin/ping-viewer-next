          ...
          <v-card-text>
            <div class="mb-4">
              <div class="d-flex align-center justify-space-between mb-4">
                ...
                <v-switch v-model="isAutoMode" hide-details density="compact"
              ...
              <div class="d-flex align-center gap-2 mb-4">
                <v-text-field v-model.number="settings.scan_start" type="number"
                  label="Start" :disabled="isAutoMode"
                  density="compact" hide-details style="width: 80px"
                  @update:modelValue="handleRangeChange" />
                <v-text-field v-model.number="settings.scan_length" type="number"
                  label="Length" :disabled="isAutoMode"
                  density="compact" hide-details style="width: 80px"
                  @update:modelValue="handleRangeChange" />
              </div>
