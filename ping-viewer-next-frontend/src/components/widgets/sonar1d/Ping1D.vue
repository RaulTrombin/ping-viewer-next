<template>
  <div class="flex flex-col h-full bg-transparent p-4" ref="containerRef">
    <WaterfallDisplay :width="width" :height="height" :sensorData="sensorData" :currentDepth="currentDepth"
      :minDepth="minDepth" :maxDepth="maxDepth" :confidence="confidence" :accuracy="accuracy"
      :colorPalette="colorPalette" :depthLineColor="depthLineColor" :depthTextColor="depthTextColor"
      :currentDepthColor="currentDepthColor" :confidenceColor="confidenceColor" :textBackground="textBackground"
      :tickCount="tickCount" :columnCount="columnCount" :getColorFromPalette="getColorFromPalette" class="flex-grow" />
