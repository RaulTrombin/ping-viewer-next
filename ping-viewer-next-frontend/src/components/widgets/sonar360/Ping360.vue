<template>
  <div ref="containerRef" class="w-full h-full flex items-center justify-center bg-gray-900 p-4">
    <div class="relative" :style="{ width: `${size}px`, height: `${size}px` }">
      <Sonar360Mask :angle="angle" :lineColor="lineColor" :lineWidth="lineWidth" :maxDistance="maxDistance"
        ...
        :radiusLineColor="radiusLineColor" :markerColor="markerColor" :radiusLineWidth="radiusLineWidth"
        :startAngle="startAngle" :endAngle="endAngle">
        <Sonar360Shader :measurement="measurement" :numLines="400" :lineLength="1202" :color-palette="colorPalette"
          :get-color-from-palette="getColorFromPalette" :startAngle="startAngle" :endAngle="endAngle"
          :yaw_angle="yaw_angle" :debug=false />
      </Sonar360Mask>
    </div>
