...
async fn init() -> Result<Json<crate::server::protocols::v1::structure::AnsPackage>, Error> {
    // let package = packages::init();
    DeviceManager::init().await;
...
#[api_v2_operation]
#[get("v1/settings/stop")]
async fn stop() -> Result<Json<crate::server::protocols::v1::structure::AnsPackage>, Error> {
    DeviceManager::stop().await;
    let package = crate::server::protocols::v1::structure::AnsPackage::new(
        crate::server::protocols::v1::structure::Operation::Settings,
    );
    Ok(Json(package))
...
#[api_v2_operation]
#[get("v1/settings/ws_start")]
async fn ws_start() -> Result<Json<crate::server::protocols::v1::structure::AnsPackage>, Error> {
    DeviceManager::subscribe().await;
    let package = crate::server::protocols::v1::structure::AnsPackage::new(
        crate::server::protocols::v1::structure::Operation::Settings,
    );
    Ok(Json(package))
